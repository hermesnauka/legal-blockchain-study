...
**MVP scope (Must):** 58 points. Definition of Done: acceptance criteria pass, unit tests cover core/crypto/consensus, XML doc comments explain the compliance/security rationale, texts available in EN and PL.
